...
# Tableau rÈcap ‡ afficher avant les graphes dans Rshiny (format tableau)
...
#Cluster 1 : Les professionnels -> arrivÈs relativement rÈcemment sur la plateforme, revues rÈcentes, beaucoup de listings
#Cluster 2 : Les ambassadors 
#Cluster 3 : Les early adopters
#Cluster 4: Les nouveaux qui expÈrimentent la plateforme
